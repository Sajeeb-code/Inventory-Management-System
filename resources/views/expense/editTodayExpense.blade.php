                             ...
                             <div class="col-md-10">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Add Expense
                                         ...
                                         &nbsp;<a href="{{ route('month.expense') }}" class="btn btn-success pull-right" >This Month</a>
                                    </h3>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        @endif
                                        <form role="form" method="post" action="{{ url('/update-today-expense/'.$edittodayExpense->id) }}" >
                                           {{ csrf_field() }}
                                            {{ method_field('PUT') }}
                                            <div class="col-md-8">
                                                 <div class="form-group">
                                                    <label for="expense_details">Expense Details</label>
                                                    <textarea name="expense_details" id="expense_details" cols="10" rows="6" class="form-control">
                                                        {{ $edittodayExpense->expense_details }}
                                                    </textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="expense_amount">Amount</label>
                                                    <input type="text" class="form-control" id="expense_amount" name="expense_amount" placeholder="Enter amount" value="{{ $edittodayExpense->expense_amount }}">
                                                </div>
                                                 <div class="form-group"> 
