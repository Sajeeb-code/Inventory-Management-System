                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                       <h3 class="text-danger">Monthly Total Expense
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    {{-- @php
                                                        if ( $month  = 'January') {
                                                            $thisMonthexpense = DB::table('expenses')->where('month',$month)->sum('expense_amount');
                                                        }
                                                        ...
                                                        elseif ( $month  = 'November') {
                                                            $thisMonthexpense = DB::table('expenses')->where('month',$month)->sum('expense_amount');
                                                            echo '<h3 style="color: red; text-align:center"> Total Expenses = {{ $thisMonthexpense }} Taka</h3>';
                                                    ...
                                                    @endphp --}}
                                                 <h3 style="color: red; text-align:center"> Total {{ date('F') }} Expenses = {{ $thismonthxpense }} Taka</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
