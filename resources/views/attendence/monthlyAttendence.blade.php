                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                     ...
                                     <h4 class="text-danger text-center" > View Attendence for {{ $attendenceReport->att_month }} month</h4>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <table  id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            @foreach($viewAllMonthAttendence as $employee)
                                                                    <tr>
                                                                        <td>{{ $employee->name }}</td>
                                                                        ...
                                                                        <td>
                                                                            <input type="radio" name="attendence[{{ $employee->id }}]" value="Present" required disabled
                                                                            <?php if ($employee->attendence =='Present') {
                                                                                echo 'checked';
                                                                            } ?>
                                                                            > Present
                                                                            <input type="radio" name="attendence[{{ $employee->id }}]" value="Absent" disabled
